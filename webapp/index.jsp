...
<body>
	...
	<img src="images/gunGP.png" height="70%" width="20%" style ="margin-top: 1 rem; float: left;">
	<img src="images/objectGP.png" height="70%" width="20%" style ="margin-top: 1 rem; float: left;"> 
	<img src="images/findGP.png" height="70%" width="20%" style = "margin-top: 1 rem; float: left;"> 
	<div>
		<span class="right-text" id="rightTxt"> 
		<p>FOG it's a mini-game maden by LibGDX FrameWork
		<p>Contains of 3 game modes and 3 difficulties for each game modes
		<p>Have the upgrade system and statistic after the game
		<p> Fun To Play and Enjoy gaming!
		<p> Copyright Spanchsan.
		</span>
	</div>
	<footer id="footer">
